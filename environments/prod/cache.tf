...
# Description: Prod environment ElastiCache Valkey module composition.

# Create a private Valkey cache in the data subnet tier for production application workloads.
module "valkey" {
