...
# Description: Staging environment ElastiCache Valkey module composition.

# Create a private Valkey cache in the data subnet tier for staging application validation.
module "valkey" {
