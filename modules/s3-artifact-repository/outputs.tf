...
# Map of created bucket names indexed by repository type
output "bucket_names" {
...
# Map of bucket ARNs for IAM policy creation
output "bucket_arns" {
...
# Map of fully qualified S3 URIs for enabled repositories
